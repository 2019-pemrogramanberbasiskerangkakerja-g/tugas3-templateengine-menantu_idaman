...
CREATE SUBSCRIPTION pbkk_client CONNECTION 'user=pbkk password=nuzulcarrykita host=192.168.137.1 port=5432 dbname=pbkk' PUBLICATION pbkk_master WITH (connect = false, slot_name = 'pbkk_client');
